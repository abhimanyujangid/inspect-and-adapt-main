...
const ALARMS = [
  { t: "12:42:18", sev: "critical", code: "E-3041", msg: "Rejector cylinder timeout — line 2", ack: false },
  { t: "12:39:02", sev: "warning", code: "W-1208", msg: "Camera exposure auto-corrected (+12%)", ack: false },
  { t: "12:31:55", sev: "info", code: "I-0021", msg: "Profile switched to Bottle Cap V2", ack: true },
  { t: "12:22:10", sev: "warning", code: "W-1142", msg: "Conveyor speed deviation 6%", ack: true },
  { t: "11:58:33", sev: "critical", code: "E-3017", msg: "PLC heartbeat lost (recovered 4s)", ack: true },
  { t: "11:40:09", sev: "info", code: "I-0007", msg: "Model loaded: bcap_v2_resnet50_q.onnx", ack: true },
] as const;
